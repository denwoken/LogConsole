...
void LogWidgetSettings::loadSettings()
{
    ...
    ui->lineEdit_logFilePath->setText(m_console->m_logFilePath);
    ui->lineEdit_ConsoleSettingsPath->setText(m_console->m_settingsFilePath);
...
void LogWidgetSettings::saveSettings()
{
    ...
    m_console->m_logFilePath = ui->lineEdit_logFilePath->text();
    m_console->m_settingsFilePath = ui->lineEdit_ConsoleSettingsPath->text();
